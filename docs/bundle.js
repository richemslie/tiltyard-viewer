...
/***/ function(module, exports, __webpack_require__) {
	...
	React.createElement(MatchSelectingDisplay_1.MatchSelectingDisplay, null), document.getElementById("example"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MatchSelectingDisplay = (function (_super) {
	    ...
	    MatchSelectingDisplay.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", { className: "vertical-match-selecting-display" },
	            React.createElement("div", { className: "match-display-column" }, this.state.curMatchUrl
	                ? React.createElement(SingleMatchDisplay_1.SingleMatchDisplay, { matchUrl: this.state.curMatchUrl })
	                : "No match selected."),
	            React.createElement("div", { className: "match-selector-column" },
	                React.createElement(VerticalMatchList_1.VerticalMatchList, { matchSummaries: this.state.availableMatchSummaries || [], onSelectMatch: function (matchId) {
	                        _this.setState({ curMatchUrl: matchId });
	    ...
	    MatchSelectingDisplay.prototype.componentDidMount = function () {
	        ...
	        fetch(matchListUrl)
	            ...
	            .then(function (body) {
	            var rawMatchesList = JSON.parse(body);
	            var summaries = rawMatchesList.queryMatches.map(toMatchSummary);
	            _this.setState({
	        ...
	        fetch(gameMetadataUrl)
	            .then(function (response) { return response.text(); })
	            .then(function (body) {
	            var gamesMetadata = JSON.parse(body);
	            _this.setState({
	                allGamesMetadata: gamesMetadata,
	            });
	        });
	        // Start the regular match reloader
	        this.reloadMatchesRef = setInterval(function () { return _this.reloadMatches(); }, 20000);
	    };
	    MatchSelectingDisplay.prototype.componentWillUnmount = function () {
	        clearInterval(this.reloadMatchesRef);
	    };
	    MatchSelectingDisplay.prototype.reloadMatches = function () {
	        var _this = this;
	        var oldSummaries = this.state.availableMatchSummaries;
	        ...
	        fetch(matchListUrl)
	            ...
	            .then(function (body) {
	            var rawMatchesList = JSON.parse(body);
	            var newSummaries = rawMatchesList.queryMatches.map(toMatchSummary);
	            _this.mergeOldSummariesIntoNew(oldSummaries, newSummaries);
	            _this.setState({
	    ...
	    MatchSelectingDisplay.prototype.mergeOldSummariesIntoNew = function (oldSummaries, newSummaries) {
	        var alreadyAdded = new Set(newSummaries.map(function (summary) { return summary.matchUrl; }));
	        oldSummaries.forEach(function (summary) {
	            if (!alreadyAdded.has(summary.matchUrl)) {
	                newSummaries.push(summary);
	            }
	        });
	    };
	    return MatchSelectingDisplay;
	}(React.Component));
	exports.MatchSelectingDisplay = MatchSelectingDisplay;
	var GAME_NAME_FROM_URL_GETTER = function (matchSummary) {
	...
	function gameNameFromMetadataGetter(allGamesMetadata) {
	    return function (matchSummary) {
	        var gameMetaUrl = matchSummary.gameMetaUrl;
	        // Still kind of hacky: get the game key
	        var gameKey = getGameKeyFromMetaUrl(gameMetaUrl);
	        var gameMetadata = allGamesMetadata[gameKey];
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var React = __webpack_require__(1);
	var VerticalMatchList = (function (_super) {
	    __extends(VerticalMatchList, _super);
	    function VerticalMatchList() {
	        return _super !== null && _super.apply(this, arguments) || this;
	    }
	    VerticalMatchList.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", null,
	            " ",
	            "Matches: ",
	            this.props.matchSummaries.map(function (matchSummary) {
	                return React.createElement("div", { className: "vertical-match-summary", key: matchSummary.matchUrl },
	                    React.createElement("a", { onClick: function () { return _this.props.onSelectMatch(matchSummary.matchUrl); } },
	    ...
	    return VerticalMatchList;
	}(React.Component));
	exports.VerticalMatchList = VerticalMatchList;
	function getGoalInfo(matchSummary, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingleMatchDisplay = (function (_super) {
	    __extends(SingleMatchDisplay, _super);
	    function SingleMatchDisplay(props) {
	        var _this = _super.call(this, props) || this;
	        _this.state = { computedVisualizationsByTurn: [] };
	        return _this;
	    }
	    SingleMatchDisplay.prototype.render = function () {
	        return React.createElement("div", { className: "singleMatchDisplay" },
	            React.createElement("div", { className: "sidePanel", key: "sidePanel" }, this.state.match ? this.getMatchSidebar() : "Loading..."),
	            React.createElement("div", { className: "mainPanel", key: "mainPanel" },
	                React.createElement("div", { id: "vizPanel" }, this.getVizPanel())));
	    };
	    SingleMatchDisplay.prototype.componentWillReceiveProps = function (nextProps, nextContext) {
	        var _this = this;
	        if (this.props.matchUrl !== nextProps.matchUrl) {
	            setTimeout(function () {
	                ...
	                _this.loadGameAndMatch();
	            });
	        }
	    };
	    SingleMatchDisplay.prototype.componentDidMount = function () {
	        var _this = this;
	        ...
	        // Start the regular match reloader
	        this.reloadMatchRef = setInterval(function () { return _this.reloadMatchOnly(); }, 10000);
	    };
	    SingleMatchDisplay.prototype.componentWillUnmount = function () {
	        clearInterval(this.reloadMatchRef);
	    };
	    SingleMatchDisplay.prototype.loadGameAndMatch = function () {
	        var _this = this;
	        var matchJsonUrl = this.props.matchUrl;
	        fetch(matchJsonUrl)
	            .then(function (response) { return response.text(); })
	            .then(function (body) {
	            ...
	            fetch(gameMetaURL)
	                ...
	                if (game.stylesheet) {
	                    ...
	                    fetch(stylesheetUrl)
	                        ...
	                        _this.setState(function (prevState, props) { return (_.assign({}, prevState, { stylesheet: stylesheet })); });
	                        _this.startComputingVizForTurn(turnNumber);
	                    });
	                }
	            });
	        });
	    };
	    SingleMatchDisplay.prototype.reloadMatchOnly = function () {
	        var _this = this;
	        ...
	        fetch(matchJsonUrl)
	            ...
	            if (onLastTurn) {
	                ...
	                _this.setState({ match: match });
	            }
	        });
	    };
	    SingleMatchDisplay.prototype.decrementTurnNumber = function () {
	        if (this.state.turnNumber != undefined
	            && this.state.turnNumber > 0) {
	            this.setTurnNumber(this.state.turnNumber - 1);
	        }
	    };
	    SingleMatchDisplay.prototype.incrementTurnNumber = function () {
	        if (this.state.turnNumber != undefined
	    ...
	    SingleMatchDisplay.prototype.startComputingVizForTurn = function (turnNumber) {
	        var _this = this;
	        new Promise(function (resolve, reject) {
	            setTimeout(function () {
	                if (_this.state.computedVisualizationsByTurn[turnNumber]) {
	                    // Already computed
	                }
	                else {
	                    var matchXml = $.parseXML(_this.getMatchXml(turnNumber));
	                    var stylesheetXml = $.parseXML(_this.state.stylesheet);
	                    var visualizationNode = xslt_1.applyXslt(matchXml, stylesheetXml);
	                    var visualizationHtml = html_1.getHtmlDestructively(visualizationNode);
	                    resolve(visualizationHtml);
	                }
	            });
	        }).then(function (visualizationHtml) {
	            if (_this.state.computedVisualizationsByTurn[turnNumber]) {
	                // Already computed
	                return;
	            }
	            var cache = _this.state.computedVisualizationsByTurn;
	            var updatedCache = _.clone(cache);
	            updatedCache[turnNumber] = visualizationHtml;
	            _this.setState({ computedVisualizationsByTurn: updatedCache });
	        });
	    };
	    SingleMatchDisplay.prototype.getVizPanel = function () {
	        if (!this.state.match) {
	            ...
	            var visualization = this.state.computedVisualizationsByTurn[this.getTurnNumber()];
	            return React.createElement(RawHtmlVisualization_1.RawHtmlVisualization, { html: visualization });
	        }
	    };
	    SingleMatchDisplay.prototype.getTurnNumber = function () {
	        if (this.state.turnNumber != undefined) {
	    ...
	    SingleMatchDisplay.prototype.getMatchXml = function (turnNumber) {
	        var stateString = this.state.match.states[turnNumber];
	        // Remove outer parentheses
	        stateString = stateString.trim();
	        stateString = stateString.slice(1, stateString.length - 1).trim();
	        // Convert into facts, then XML
	        var xml = "<state>" + this.toFacts(stateString) + "</state>";
	        return xml;
	    };
	    SingleMatchDisplay.prototype.toFacts = function (stateString) {
	        ...
	        while (index < tokens.length) {
	            ...
	            if (token === "(") {
	                ...
	                index++;
	                var name_1 = tokens[index];
	                factsXml += "<relation>" + name_1 + "</relation>";
	                depth++;
	            }
	            else if (token === ")") {
	                depth--;
	    ...
	    SingleMatchDisplay.prototype.getMatchSidebar = function () {
	        var _this = this;
	        return React.createElement(MatchInfo_1.MatchInfo, { match: this.state.match, gameMetadata: this.state.gameMetadata, turnNumber: this.state.turnNumber, setTurnNumber: function (turnNumber) { return _this.setTurnNumber(turnNumber); } });
	    };
	    SingleMatchDisplay.prototype.setTurnNumber = function (turnNumber) {
	        this.startComputingVizForTurn(turnNumber);
	        this.setState({ turnNumber: turnNumber });
	    };
	    return SingleMatchDisplay;
	}(React.Component));
	exports.SingleMatchDisplay = SingleMatchDisplay;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var React = __webpack_require__(1);
	var MovesTable_1 = __webpack_require__(13);
	var MatchInfo = (function (_super) {
	    __extends(MatchInfo, _super);
	    function MatchInfo() {
	        return _super !== null && _super.apply(this, arguments) || this;
	    }
	    MatchInfo.prototype.render = function () {
	        return React.createElement("div", null,
	    ...
	    MatchInfo.prototype.getGameName = function () {
	        ...
	        if (this.props.gameMetadata) {
	            var searchTerm = "//games.ggp.org/";
	            var foundIndex = metaUrl.indexOf(searchTerm);
	            if (foundIndex >= 0) {
	                var repoStartIndex = foundIndex + searchTerm.length;
	                var repoEndIndex = metaUrl.indexOf("/", repoStartIndex);
	                var repoName = metaUrl.slice(repoStartIndex, repoEndIndex);
	                var slashAfterGamesIndex = metaUrl.indexOf("/", repoEndIndex + 1);
	                var humanUrl = metaUrl.slice(0, foundIndex)
	                    + "//www.ggp.org/view/all/games/"
	                    + repoName
	                    + metaUrl.slice(slashAfterGamesIndex);
	                return React.createElement("a", { href: humanUrl }, this.props.gameMetadata.gameName);
	            }
	            return React.createElement("text", null, this.props.gameMetadata.gameName);
	        }
	        return React.createElement("text", null, metaUrl);
	    };
	    MatchInfo.prototype.getPlayersInvolved = function () {
	        var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovesTable = (function (_super) {
	    __extends(MovesTable, _super);
	    function MovesTable() {
	        return _super !== null && _super.apply(this, arguments) || this;
	    }
	    MovesTable.prototype.render = function () {
	        return React.createElement("table", null,
	            React.createElement("thead", null, this.getRoleNameHeader()),
	            React.createElement("tbody", null,
	                this.getPreMovesRow(),
	                this.getMoveRows()));
	    };
	    MovesTable.prototype.getRoleNameHeader = function () {
	        if (this.props.roleNames) {
	            return React.createElement("tr", null,
	                React.createElement("th", null, "Turn"),
	                this.props.roleNames.map(function (roleName, index) {
	                    return React.createElement("th", { key: index }, roleName);
	                }));
	        }
	        else if (this.props.movesByTurn.length > 0) {
	            var numRoles = this.props.movesByTurn[0].length;
	            return React.createElement("tr", null,
	                React.createElement("th", null, "Turn"),
	                React.createElement("th", { colSpan: numRoles }, "Loading..."));
	        }
	        else {
	            return React.createElement("tr", null,
	                React.createElement("th", null, "Turn"),
	                React.createElement("th", null, "Loading..."));
	        }
	    };
	    MovesTable.prototype.getPreMovesRow = function () {
	        var _this = this;
	        var arrow = (0 === this.props.turnNumber) ? "> " : "";
	        return React.createElement("tr", { key: "premoves", onClick: function () { _this.props.setTurnNumber(0); } },
	            React.createElement("td", { key: "moveNum", className: "turn-number" }, arrow + 0),
	    ...
	    MovesTable.prototype.getPreMovesCells = function (count) {
	        return lodash_1.range(count).map(function (index) { return React.createElement("td", { key: index }, "\u2014"); });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var React = __webpack_require__(1);
	var RawHtmlVisualization = (function (_super) {
	    __extends(RawHtmlVisualization, _super);
	    function RawHtmlVisualization() {
	        return _super !== null && _super.apply(this, arguments) || this;
	    }
	    RawHtmlVisualization.prototype.render = function () {
	        return React.createElement("div", { dangerouslySetInnerHTML: this.getContents() });
	    };
	    RawHtmlVisualization.prototype.getContents = function () {
	        return {
	            __html: this.props.html,
	        };
	    };
	    return RawHtmlVisualization;
	}(React.Component));
	exports.RawHtmlVisualization = RawHtmlVisualization;
